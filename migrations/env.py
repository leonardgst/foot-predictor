...
Point d'entrée Alembic. Récupère l'URL de connexion depuis
foot_predictor.config (donc depuis .env.{APP_ENV}) plutôt que
depuis alembic.ini, pour ne jamais committer d'identifiants.
"""
